...
<div id="years_distribution" style="width: 800px; height: 700px">
...
//| output: false
{
    ...
    const width = 800;
    const height = 700;
    const svg = container.append("svg") // Dynamically appending the SVG to the div container
        .attr("width", width)
        .attr("height", height);

    const margin = {top: 20, right: 60, bottom: 40, left: 60}; // Adjusted left margin for label space
    ...
    g.selectAll(".bar")
        ...
        .attr("width", d => x(d.count)) // Set width based on the count
