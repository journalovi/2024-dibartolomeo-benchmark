...
A number of papers used individual, **Single Graphs** for their experiments instead of a collection. These graphs have
become popular because of their properties as individual graphs - see, for example,
the <a href="#enron" class="dataset-link">Enron</a> dataset below, a
huge individual graph that has a large variance in node degree distribution. Many of these graphs are also available in
other repositories - their locations are noted wherever known.
