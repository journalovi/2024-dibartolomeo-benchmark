...
* ... graph data, graph fromat conversion code, and analysis code: <https://osf.io/j2tfs/> ([github.com/VisDunneRight/benchmark_sets_analysis_data/](https://github.com/VisDunneRight/benchmark_sets_analysis_data/))
